...
// dataTemplate_bash reads file data from disk. It returns an error on failure.
func dataTemplate_bash() (*asset, error) {
	path := "/opt/go/src/github.com/milanaleksic/mongodiff/data/template_bash"
	name := "data/template_bash"
...
// dataTemplate_bat reads file data from disk. It returns an error on failure.
